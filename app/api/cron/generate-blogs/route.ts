...
export async function POST(req: NextRequest) {
  try {
    ...
    // This prevents cron-job.org (30s) and Render (100s) from timing out and killing the email task
    ...
    // Immediately return success so Render/cron-job.org doesn't timeout
