...
export default function BlogListClient({ blogs }: { blogs: BlogMeta[] }) {
  ...
  // Blog card component
  const BlogCard = ({ blog, size = "normal" }: { blog: BlogMeta; size?: "normal" | "small" | "horizontal" }) => {
    if (size === "horizontal") {
      return (
          ...
          <div className="flex gap-4 items-start p-3 rounded-xl hover:bg-[#161b22] transition-colors">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-3 mt-2 text-[10px] text-[#484f58]">
                <span className="flex items-center gap-1"><Clock className="h-2.5 w-2.5" />{blog.readTime} min</span>
                  ...
                  <div className="relative rounded-2xl overflow-hidden border border-[#30363d] hover:border-[#58a6ff]/40 transition-all duration-500 shadow-2xl hover:shadow-[#58a6ff]/10">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-10 md:p-14">
                      ...
                      <div className="flex items-center gap-6">
                        ...
                        <span className="text-xs text-[#7d8590] flex items-center gap-1"><Clock className="h-3.5 w-3.5" />{featured.readTime} min read</span>
